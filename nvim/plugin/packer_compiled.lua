...
_G.packer_plugins = {
  ...
  catppuccin = {
    loaded = true,
    path = "/home/amit/.local/share/nvim/site/pack/packer/start/catppuccin",
  ...
  gruvbox = {
    loaded = true,
    path = "/home/amit/.local/share/nvim/site/pack/packer/start/gruvbox",
  ...
  ["popup.nvim"] = {
    loaded = true,
    path = "/home/amit/.local/share/nvim/site/pack/packer/start/popup.nvim",
  ...
  ["tokyonight.nvim"] = {
    loaded = true,
    path = "/home/amit/.local/share/nvim/site/pack/packer/start/tokyonight.nvim",
